# this file contains models which aim at building graph structure given node features
...
class MLP_Diag(nn.Module):
    ...
    def forward(self, features, pre_A):
        if self.sparse:
...
class MLP(nn.Module):
    def __init__(self, nlayers, isize, hsize, osize, features, mlp_epochs, k, knn_metric, non_linearity, i, sparse, mlp_act):
